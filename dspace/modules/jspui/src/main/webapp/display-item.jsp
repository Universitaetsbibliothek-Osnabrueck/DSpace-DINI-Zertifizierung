<%-- Änderungen durch MODIFIED markiert --%>
...
<%
	...
	//MODIFIED: DNB-Resolver bei Nutzung von URNs. (M.5-8)
	
    String preferredIdentifier = "https://nbn-resolving.org/" + handle;
...
%>
		...
		<%-- MODIFIED URL ist verlinkt, OA-Logo eingebunden (M.1-4)--%>

               <div class="well row">
                   <div style="float:left">
                           <fmt:message key="jsp.display-item.identifier"/><br/><a href="<%= preferredIdentifier %>"><%= preferredIdentifier %></a>
                   </div>
                   <div style="float:right">
                           <img alt="Open Access logo originally created by the Public Library of Science (PLoS)" title="Open Access logo originally created by the Public Library of Science (PLoS)" src="/image/Open_Access_PLoS_transparent.svg" height="50px"/>
                   </div>
           </div>
<%
...
%>
<br/>
<%-- MODIFIED: Anzeige rightsstatement.org im Copyright-Fall (M.4-10, M.4-11), CC-Icon passend zur Lizenz im CC-Fall
    <%-- Create Commons Link --%>
<%
    if (cc_url != null)
    {
		String iconURL = "https://licensebuttons.net/l/"+ cc_url.split("/")[4] +"/3.0/88x31.png";
%>
    ...
    <a href="<%= cc_url %>"><img src="<%= iconURL %>" border="0" alt="Creative Commons" style="margin-top: -5px;" class="pull-right"/></a>
    </p>
    <!--
    <%= cc_rdf %>
    -->
...
%>
    <p class="submitFormHelp alert alert-info"><fmt:message key="jsp.display-item.copyright"/> <a href="http://rightsstatements.org/page/InC/1.0/">rightsstatements.org</a>
	<a href="http://rightsstatements.org/page/InC/1.0/"><img src="http://rightsstatements.org/files/icons/InC.Icon-Only.dark.svg" height="33" border="0" alt="Creative Commons" style="margin-top: -5px;" class="pull-right"/></a>
	</p>
	<!-- 
    ...
    <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
	  ...
	  <dc:RightsStatement rdf:about="http://rightsstatements.org/vocab/InC/1.0/">
	    <rdf:type rdf:resource="http://www.w3.org/2004/02/skos/core#Concept"/>
	    <dc11:identifier>InC</dc11:identifier>
	    <dc:creator rdf:resource="http://rightsstatements.org/vocab/irswg"/>
	    <dc:modified rdf:datatype="http://www.w3.org/2001/XMLSchema#date">2016-05-09</dc:modified>
	    <owl:versionInfo>1.0</owl:versionInfo>
	    <skos:closeMatch rdf:resource="http://www.europeana.eu/rights/rr-f/"/>
	    <skos:definition xml:lang="en">This Item is protected by copyright and/or related rights.
	
	  You are free to use this Item in any way that is permitted by the copyright and related rights legislation that applies to your use.
	
	  For other uses you need to obtain permission from the rights-holder(s).</skos:definition>
	    <skos:inScheme rdf:resource="http://rightsstatements.org/vocab/1.0/"/>
	    <skos:note xml:lang="en">You may find additional information about the copyright status of the Item on the website of the organization that has made the Item available.</skos:note>
	    <skos:note xml:lang="en">Unless expressly stated otherwise, the organization that has made this Item available makes no warranties about the Item and cannot guarantee the accuracy of this Rights Statement. You are responsible for your own use.</skos:note>
	    <skos:note xml:lang="en">You may need to obtain other permissions for your intended use. For example, other rights such as publicity, privacy or moral rights may limit how you may use the material.</skos:note>
	    <skos:prefLabel xml:lang="en">In Copyright</skos:prefLabel>
	    <skos:relatedMatch rdf:resource="http://id.loc.gov/vocabulary/preservation/copyrightStatus/cpr"/>
	    <skos:scopeNote xml:lang="en">This Rights Statement can be used for an Item that is in copyright. Using this statement implies that the organization making this Item available has determined that the Item is in copyright and either is the rights-holder, has obtained permission from the rights-holder(s) to make their Work(s) available, or makes the Item available under an exception or limitation to copyright (including Fair Use) that entitles it to make the Item available.</skos:scopeNote>
	  </dc:RightsStatement>
