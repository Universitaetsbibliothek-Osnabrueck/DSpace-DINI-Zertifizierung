<%-- Änderung durch MODIFIED markiert --%>
...
%>
       ...
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
        ...
        <li class="dropdown-header"><fmt:message key="jsp.layout.navbar-default.browseitemsby"/></li>
		  ...
		  <%-- MODIFIED: Dropdown statt Hilfebutton; dies ist nur beispielhaft angelegt und v.a. nicht komplett lokalisiert über fmt:message-Auszeichnungen, die lokalisierte Strings aus den message.properties-Dateien holen würden. --%>
		  
          <li class="dropdown">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="jsp.layout.navbar-default.help"/> <b class="caret"></b></a>
			<ul class="dropdown-menu">
				<li class="dropdown-header">Externe Links</li>
				<li><a href="https://www.ub.uni-osnabrueck.de" target="_blank">UB-Homepage</a></li>
				<li class="divider"></li>
				<li class="dropdown-header"><fmt:message key="jsp.layout.navbar-default.help"/></li>
				<li><dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.index\") %>"><fmt:message key="jsp.layout.navbar-default.help"/></dspace:popup></a>
			</ul>
		  </li>
       </ul>
