...
public class LogManager
{
            ...
            String extrainfo)
    {
        ...
        result.append(escapeLogField(email)).append(":")
                .append(contextExtraInfo).append(":")
                .append(escapeLogField(action)).append(":")
                .append(escapeLogField(extrainfo));
        return result.toString();
    }

    /**
     * If any string within the log line contains a field separator (:) they
     * need to be escaped so as the line may be parsed and analysed later. This
     * method will escape a log field.
     * 
     * Single slashes and colons will be escaped so that colons no longer appear
     * in the logs
     * 
     * @param field
